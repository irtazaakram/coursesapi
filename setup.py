#!/usr/bin/env python
"""
Package metadata for coursesapi.
"""
import os
import re
import sys
...
VERSION = get_version('coursesapi', '__init__.py')
...
setup(
    name='coursesapi',
    version=VERSION,
    description="""Django REST Api to list/filter edx courses""",
    long_description=README + '\n\n' + CHANGELOG,
    author='edX',
    author_email='oscm@edx.org',
    url='https://github.com/openedx/coursesapi',
    packages=find_packages(
        include=['coursesapi', 'coursesapi.*'],
        exclude=["*tests"],
    ),
